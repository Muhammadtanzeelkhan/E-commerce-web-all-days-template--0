  ...
  return (
    <div>
            ...
            <div className="grid grid-cols-5 py-4 px-10 font-normal text-[16px] text-[#9F9F9F] items-center max-sm:text-[14px] max-sm:grid-cols-4">
              <div>
                <Image
                  ...
                  src="/images/mainsofy.png"
                  alt="Product"
                  className="w-full h-auto max-sm:w-16"
                />
              </div>
      ...
      {/* <div className="bg-[#FAF3EA] mt-16">
        <div className="grid grid-cols-4 max-sm:grid-cols-2 px-14 py-28 items-center gap-12 max-sm:py-14 max-sm:px-7"> */}
